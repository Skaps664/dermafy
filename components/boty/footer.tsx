...
const footerLinks = {
  ...
  about: [
    ...
    { name: "Active Ingredients", href: "/about/ingredients" },
    { name: "Clinical Standards", href: "/about/clinical-standards" },
    { name: "DRAP Registration", href: "/about/drap-registration" }
  ],
  support: [
        ...
        <div className="pt-10 border-t border-border/50">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-sm text-muted-foreground">
              © {new Date().getFullYear()} Dermafy. All rights reserved.
            </p>
